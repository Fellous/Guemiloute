<?php
// commit name: fix-edit-profile-for-current-user
// - Corrige les headers already sent
// - Relie la page au profil de l'utilisateur connecté

// Assure-toi qu'il n'y a pas d'espace avant cette ligne
session_start();

// Vérifie si l'utilisateur est connecté et s'il est un prêteur
...
// Si l'utilisateur n'a pas encore de données, on initialise par défaut
        ...
        <div class="mb-3">
            ...
            ?>
                <div class="row mb-2">
                    ...
                    <div class="col-8">
                        <input type="text" class="form-control" name="availability[<?= $day ?>]" 
                               placeholder="ex: 10:00-18:00" value="<?= htmlspecialchars($availability[$day] ?? '') ?>">
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
